...
mv /home/funkytaiga/tmp_champ/ChampSim-Ramulator/tmp_gc_marked_pages_files/freq_gc_200.txt /home/funkytaiga/tmp_champ/ChampSim-Ramulator/tmp_gc_marked_pages_files/${SAMPLE_FILENAME_NO_DOT}_${WARMUP}_${SAMPLE_INST}_unmarked_obj.txt
