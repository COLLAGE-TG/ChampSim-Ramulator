...
HBM::HBM(const string& org_str, const string& speed_str): HBM(org_map[org_str], speed_map[speed_str])
{
}
...
#if (ADD_HBM_1MB == ENABLE || ADD_HBM_8MB == ENABLE || ADD_HBM_64MB == ENABLE || ADD_HBM_128MB == ENABLE)
